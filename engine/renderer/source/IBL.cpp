...
namespace engine::renderer
{
    ...
    void IBL::create(std::shared_ptr<openglcore::Shader> equirectangularToCubemapShader,
        ...
        std::shared_ptr<openglcore::Shader> brdfShader)
    {
       ...
       // ----------------------
        ...
        float* data = stbi_loadf((utils::FileSystem::getRootPath() + "/assets/textures/hdr/golf.hdr").c_str(), &width, &height, &nrComponents, 0);
        if (data)
        {
        ...
        // ----------------------------------------------------------------------
        equirectangularToCubemapShader->UseShaderProgram();
